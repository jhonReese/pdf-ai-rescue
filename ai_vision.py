...
# 鎖定 Phase 1 攻頂所屬：微積分、線性代數核心字彙與 GRE 高頻學術字
...
def process_and_extract(target_dir, output_pdf, skip_merge=False):
    ...
    # Output 2: Phase 1 Anki 閃卡牌組 (CSV)
